...
issue](https://github.com/mcdonnnj/actions_playground/issues) in this
...
request](https://github.com/mcdonnnj/actions_playground/pulls), you will
...
```console
cd actions_playground
pyenv virtualenv <python_version_to_use> actions_playground
pyenv local actions_playground
